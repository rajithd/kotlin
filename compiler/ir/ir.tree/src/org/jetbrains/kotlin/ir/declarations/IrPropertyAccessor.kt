...
abstract class IrPropertyAccessorBase(
        ...
        override val body: IrFunctionBody
...
class IrPropertyGetterImpl(
        ...
        property: IrProperty,
        body: IrFunctionBody
) : IrPropertyAccessorBase(sourceLocation, containingDeclaration, property, body), IrPropertyGetter {
...
class IrPropertySetterImpl(
        ...
        property: IrProperty,
        body: IrFunctionBody
) : IrPropertyAccessorBase(sourceLocation, containingDeclaration, property, body), IrPropertySetter {
    override fun <R, D> accept(visitor: IrDeclarationVisitor<R, D>, data: D): R =
